...
```
package com.fxiaoke.demo.enumDemo;
...
为什么Enum中定义元素都是大写了吧，这是规范！

如果不相信Enum就这么简单，可以看看下面的测试

```
package com.fxiaoke;

import com.fxiaoke.demo.enumDemo.Car;
...
import com.fxiaoke.demo.enumDemo.Factory;
